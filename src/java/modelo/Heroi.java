...
@NamedQueries({
    ...
    @NamedQuery(name = "Heroi.findFilter", query = "SELECT h FROM Heroi h WHERE UPPER(h.nome) like UPPER(:filtro) "
            + "or UPPER(h.codinome) like UPPER(:filtro) "
            + "or UPPER(h.editora.nome) like UPPER(:filtro) "
            + "or UPPER(h.regiao.nome) like UPPER(:filtro) "
            + "or UPPER(h.categoria.nome) like UPPER(:filtro) "),
    @NamedQuery(name = "Heroi.findEditora", query = "SELECT h FROM Heroi h WHERE h.editora.codigo = :filtro"),
    @NamedQuery(name = "Heroi.findRegiao", query = "SELECT h FROM Heroi h WHERE h.regiao.codigo = :filtro"),
    @NamedQuery(name = "Heroi.findCategoria", query = "SELECT h FROM Heroi h WHERE h.categoria.codigo = :filtro")
//<!--acrescentar depois, o UPPER serve para ignorar maiusculas e minisculas -->
})
